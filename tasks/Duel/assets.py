...
class DuelAssets: 
	...
	# 斗技荣誉图标 
	I_DUEL_HONOR = RuleImage(roi_front=(211,636,20,20), roi_back=(180,601,217,98), threshold=0.7, method="Template matching", file="./tasks/Duel/duel/duel_duel_honor.png")
	# 胜利分享 
